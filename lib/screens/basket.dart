...
import 'package:fruit_basket/components/custom_outlined_button.dart';
...
import 'package:fruit_basket/screens/order_complete.dart';
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: OutlinedButton(
                        ...
                        onPressed: () {
                          if (cardInfoFormKey.currentState?.validate() ?? false) {
                            ref.read(basketProvider.notifier).clearBasket();
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
